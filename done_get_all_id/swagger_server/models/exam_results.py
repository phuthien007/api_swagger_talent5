...
class ExamResults(Model):
    ...
    """
    def __init__(self, exam_result_id: int=None, student_id: Students=None, exam_id: Exams=None, score: int=None, result_date: datetime=None, class_id: Classes=None, note: str=None):  # noqa: E501
