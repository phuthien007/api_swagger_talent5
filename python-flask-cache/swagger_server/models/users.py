...
class Users(Model):
    ...
    """
    def __init__(self, id: int=None, username: str=None, email: str=None, password: str=None, fullname: str=None, birthday: date=None, last_login_date: datetime=None, lockout_date: datetime=None, login_failed_count: float=None, register_date: datetime=None, forgot_password_token: str=None):  # noqa: E501
