...
class Classes(Model):
    ...
    """
    def __init__(self, id: int=None, name: str=None, start_date: datetime=None, end_date: datetime=None, course_id: Courses=None, teacher_id: Teachers=None, status: str=None):  # noqa: E501
